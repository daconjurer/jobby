...
// jobsExecutorConfig holds configuration for the executor process.
type jobsExecutorConfig struct {
	Mongo  mongodb.MongoConfig
	Pulsar config.PulsarConfig
	Topics config.JobTopicsConfig
}

func loadConfig() (jobsExecutorConfig, error) {
	var cfg jobsExecutorConfig
	var err error
